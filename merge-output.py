...
# except ImportError:
#     import json
# StartDir='/Users/philipp/BPLA Dropbox/03 Planning/DN-Dumping Detection-1087/05_Output/Output/'
# dfjson = gpd.GeoDataFrame(columns=['location','geometry'])
#  # iterate through multiple tif files in a folder
#  for dir, subdir, files in os.walk(StartDir):
#      for fname in files:
#          if fname.endswith(".ge0json"):
...
#
#
# with open(StartDir+"piles-combined.geojson", 'w') as fp:
# 	json.dump(piles, fp, indent=4)
#
# f.close()
