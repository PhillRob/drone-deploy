...
def main(argv):
    ...
    #geojsonFilename='/Users/philipp/BPLA Dropbox/03 Planning/DN-Dumping Detection-1087/05_Output/Digitisation/Version-3/Complete-stockpiles-rectified-v3.geojson'
    f = open(geojsonFilename)
    data = json.load(f)
